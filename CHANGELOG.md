...
### Added
- enhance behavior parsing
- enhance system prompt formatting
...
### Added
- add state persistence example
- add event system example
- add startup evaluator example, multi agent pipeline
